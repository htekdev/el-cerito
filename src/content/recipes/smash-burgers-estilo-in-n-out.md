---
title: "Smash Burgers Estilo In-N-Out"
titleEn: "In-N-Out Style Smash Burgers"
description: "La hamburguesa saludable que Hector se inventó: smash burgers crujientes con sellado de mostaza y queso americano derretido, cebolla caramelizada y una salsa especial ligera con yogur griego y cátsup sin azúcar, sobre pan keto. Todo el sabor de In-N-Out con más proteína y menos culpa."
descriptionEn: "The healthy burger Hector came up with: crispy smash burgers with a mustard sear and melted American cheese, caramelized onions, and a light special sauce made with Greek yogurt and sugar-free ketchup, on keto buns. All the In-N-Out flavor with more protein and less guilt."
coverImage: "/images/recipes/smash-burgers-estilo-in-n-out.jpg"
coverImageAlt: "Smash burger estilo In-N-Out con queso americano derretido, cebolla caramelizada, salsa especial, lechuga y jitomate sobre pan keto"
servings: 3
servingLabel: "hamburguesas"
servingLabelEn: "burgers"
prepTime: 15
cookTime: 20
difficulty: media
ranchOriginal: false
...
ingredients:
  ...
  - name: "pan keto para hamburguesa"
    nameEn: "keto burger buns"
    amount: 3
    unit: pieces
    calories: 270
    protein: 21
  ...
  - name: "queso americano"
    ...
    fat: 14
    fiber: 0
    note: "3–6 rebanadas según sencilla o doble"
    noteEn: "3–6 slices depending on single or double patty"
  - name: "cebolla blanca"
    nameEn: "white onion"
    amount: 135
    unit: g
  ...
  - name: "mayonesa light (para la salsa)"
    ...
    note: "1/2 taza"
    noteEn: "1/2 cup"
  - name: "cátsup sin azúcar"
    nameEn: "sugar-free ketchup"
    amount: 60
    unit: g
    calories: 20
    protein: 0
  ...
  - name: "leche"
    ...
    note: "1/4 taza"
    noteEn: "1/4 cup"
  - name: "pepinillos de eneldo picados"
    nameEn: "finely diced dill pickles"
    amount: 45
    unit: g
    calories: 5
    protein: 0
    carbs: 1
    fat: 0
    note: "1/4 taza, para la salsa"
    noteEn: "1/4 cup, for the sauce"
  - name: "cebolla blanca picada (para la salsa)"
    nameEn: "finely diced white onion (for the sauce)"
    amount: 35
    unit: g
    calories: 14
    protein: 0
    ...
    note: "1/4 taza"
    noteEn: "1/4 cup"
  - name: "mostaza amarilla (para la salsa)"
    nameEn: "yellow mustard (for the sauce)"
    amount: 30
    unit: g
    calories: 20
    protein: 1
...
storyEn: |
  ...
  or two before serving for that classic fast-food feel, and keep extra sauce on the side.
pubDate: 2026-07-30
author: "Hector Rocha"
---
...
Para el sabor más parecido a In-N-Out, usa queso americano y no te saltes el sellado de
mostaza. Si una carne se empieza a romper, compacta más la mezcla y aplasta recto hacia abajo
usando papel o aluminio entre la espátula y la carne. Envuelve la hamburguesa 1–2 minutos
antes de servir para ese toque de comida rápida — y deja salsa extra a un lado.
